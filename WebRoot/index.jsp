            ...
            <ul class="nav">
                ...
                <li class="has-sub">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a href="user.do?method=loadApproveUser"><i class="fa fa-circle-o fa-fw"></i>&nbsp;推广链接审核</a></li>
                    </ul>
                </li>
            </ul>
        </div>
            ...
            <div class="col-sm-12">
                <div class="jumbotron">
                    <table>
                    	...
                    	<tr>
                    		<td>注册日期：</td>
                    		<td><fmt:formatDate pattern='yyyy-MM-dd HH时mm分' value='${sessionScope.user.createTime }' /></td>
                    		<td>点股数量(总/出局)：</td>
                    		<td></td>
                    	</tr>
                    	<tr>
